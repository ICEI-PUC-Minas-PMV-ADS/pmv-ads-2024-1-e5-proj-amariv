...
|RF-020 | Exibir um aviso na página principal do sistema | algum agendamento de coleta previamente cadastrado ser alterado | O agendamento tiver seu status alterado por qualquer usuário | quando o botão de salvar a alteração no agendamento da coleta for clicado  | Deve ser emitido um aviso para os usuários envolvidos com o agendamento da coleta.|
|RF-021 | Exibir um aviso na página principal do sistema | alguma rota previamente cadastrada ser alterada | A rota for alterada por algum usuário ou pelo administrador | quando o botão de salvar a alteração na página de cadastro de rotas for clicado  | Deve ser emitido um aviso para os usuários envolvidos com os dados da rota alterada.|
